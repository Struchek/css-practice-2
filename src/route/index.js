...
router.get('/template-1', function (req, res) {
  ...
  res.render('template-1', {
    ...
    hero: {
      title: 'Pricing',
      text: 'An extraordinary long English word!',
    },
    plans: [
      {
        name: 'Free',
    ...
    preview: [
      {
        date: 'Oct 24',
        title: 'Latest post',
        text: ' This is a wider card with supporting text below as a natural lead-in to additional contentThis is a wider card with supporting text below as a natural lead-in to additional content',
        category: [
          {
            id: 1,
            text: 'World',
